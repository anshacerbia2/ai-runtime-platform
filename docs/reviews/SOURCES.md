...
## Implementation sources inspected for documentation sync

| Source                                                                                                                                                                                                                                                                                                                 | Evidence role                                                                          |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| [Registered routes](../../packages/contracts/src/http/routes.ts), [resources](../../packages/contracts/src/http/resources.ts), [runner protocol](../../packages/contracts/src/http/runner.ts)                                                                                                                          | Actual request/response/metadata and BFF exposure                                      |
| [Prisma schema](../../prisma/schema.prisma) and [migrations](../../prisma/migrations)                                                                                                                                                                                                                                  | Physical models, state checks, atomic receipt and authority constraints                |
| [Management repository](../../apps/api/src/modules/control-plane/infrastructure/prisma-m1.repository.ts), [resource reader](../../apps/api/src/modules/control-plane/infrastructure/prisma-resource-reader.ts), [runner authority](../../apps/api/src/modules/control-plane/infrastructure/prisma-runner-authority.ts) | Transaction, scope, projection and fencing behavior                                    |
| [Browser HTTP client](../../apps/web/src/shared/api/http-client.ts), [BFF](../../apps/web/src/server/api-gateway/forward.ts), [lab hook](../../apps/web/src/features/contract-lab/hooks/use-playground.ts)                                                                                                             | Retry, bounded waits/bytes and mutation/query lifecycles                               |
| [Execution evidence](CONTRACT-EXECUTION.md) and [documentation synchronization](DOCUMENTATION-SYNC.md)                                                                                                                                                                                                                 | Dated test/source checkpoints and docs-only validation, not universal production proof |

Public references below are retained historical references; this synchronization does not assert that vendor documentation or versions were rechecked online. Current project behavior is derived from local source, not inferred from a vendor feature.
...
## Pemilihan stack — verifikasi 21 September 2026

[ADR-0016](../adr/0016-nestjs-fastify.md) memuat rujukan primer NestJS/Fastify/Express serta evaluasi klaim reviewer per bagian. [ADR-0017](../adr/0017-prisma-postgresql.md) memuat Prisma transactions/migrations dan advisory dependency. Versi package dipilih dari metadata registry npm, dipin, dan diuji pada lockfile aktual. [ADR-0018](../adr/0018-clean-architecture-quality.md) adalah keputusan internal struktur/quality, bukan klaim benchmark industri. GitHub action refs dipin dari repository resmi actions/checkout dan actions/setup-node.
